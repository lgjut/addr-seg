...
class UnknowGrammar(object):
    ...
    def add_product(self, key:list, lhs:list):
    ...
    def matchLong(self, key, offset, matchRet):
        ...
        while True:
            ...
            if charComp == 0:
                charIndex += 1
                if currentNode.nodeVal is not None and charIndex > ret:
                    ret = charIndex
                    retPOS = currentNode.nodeVal
                if charIndex == len(key):
                    matchRet.end = ret
                    matchRet.lhs = retPOS
                    return matchRet
